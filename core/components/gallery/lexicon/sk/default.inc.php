...
$_lang['gallery.album_remove_confirm'] = 'Naozaj chcete odstrániť tento album? Všetky položky, ktoré zároveň niesú aj v inom albume budú tiež odstránené.';

// $_lang['gallery.album_update'] = 'Update Album';
$_lang['gallery.album_update'] = 'Upraviť album';

// $_lang['gallery.albums'] = 'Albums';
$_lang['gallery.albums'] = 'Albumy';

// $_lang['gallery.back'] = 'Back';
$_lang['gallery.back'] = 'Späť';

// $_lang['gallery.batch_upload'] = 'Batch Upload';
$_lang['gallery.batch_upload'] = 'Dávkové nahrávanie';
...
$_lang['gallery.batch_upload_intro'] = '<p>Zadajte zložku na FTP, ktorý má byť prehľadaný. Môžete použiť placeholdery {base_path}, {core_path} alebo {assets_path}.</p>';

// $_lang['gallery.batch_upload_tags'] = 'Tags to assign to any items batch uploaded, in comma-separated list format.';
$_lang['gallery.batch_upload_tags'] = 'Tagy priradené každej položke dávkového nahrávania, zoznam oddelený čiarkou.';

// $_lang['gallery.bytes'] = 'bytes';
$_lang['gallery.bytes'] = 'bajtov';

// $_lang['gallery.comma_separated_list'] = 'Comma-separated list';
$_lang['gallery.comma_separated_list'] = 'Čiarkou oddelený zoznam';

// $_lang['gallery.clearsuccessful'] = 'Clear Successful Uploads';
$_lang['gallery.clearsuccessful'] = 'Vymazať úspešne nahrané';

// $_lang['gallery.clearfailure'] = 'Clear Failed Uploads';
$_lang['gallery.clearfailure'] = 'Vymazať neúspešne nahrané';

// $_lang['gallery.directory'] = 'Directory';
$_lang['gallery.directory'] = 'Zložka';

// $_lang['gallery.directory_desc'] = 'The directory to scan for images.';
$_lang['gallery.directory_desc'] = 'Zložka, v ktorej budú vyhľadané položky.';

// $_lang['gallery.directory_err_create'] = 'Could not create directory: [[+directory]]';
$_lang['gallery.directory_err_create'] = 'Nemožno vytvoriť zložku: [[+directory]]';

// $_lang['gallery.directory_err_nf'] = 'Directory not found.';
$_lang['gallery.directory_err_nf'] = 'Zložka nenájdená.';

// $_lang['gallery.directory_err_ns'] = 'Directory not specified.';
$_lang['gallery.directory_err_ns'] = 'Zložka nebola špecifikovaná.';

// $_lang['gallery.directory_err_write'] = 'Could not write to directory: [[+directory]]';
$_lang['gallery.directory_err_write'] = 'Nemožno zapisovať do zložky: [[+directory]]';

// $_lang['gallery.file'] = 'File';
$_lang['gallery.file'] = 'Súbor';

// $_lang['gallery.file_err_move'] = 'An error occurred while trying to move the file: [[+file]] to [[+target]]';
$_lang['gallery.file_err_move'] = 'Nastala chyba pri presune súboru: [[+file]] do [[+target]]';

// $_lang['gallery.file_name'] = 'File Name';
$_lang['gallery.file_name'] = 'Názov súboru';

// $_lang['gallery.file_size'] = 'File Size';
$_lang['gallery.file_size'] = 'Veľikosť súboru';

// $_lang['gallery.height'] = 'Height';
$_lang['gallery.height'] = 'Výška';

// $_lang['gallery.images_selected'] = '[[+count]] images selected.';
$_lang['gallery.images_selected'] = 'Vybraných [[+count]] položiek.';

// $_lang['gallery.inactive'] = 'Inactive';
$_lang['gallery.inactive'] = 'Neaktívna';

// $_lang['gallery.intro_msg'] = 'Here you can manage your albums. Right-click on an album to view more options.';
$_lang['gallery.intro_msg'] = 'V tejto časti môžete spravovať svoje albumy. Pravým kliknutím na album získate ďaľšie možnosti.';

// $_lang['gallery.item_delete'] = 'Delete Item';
$_lang['gallery.item_delete'] = 'Odstrániť';

// $_lang['gallery.item_delete_confirm'] = 'Are you sure you want to delete this item entirely? This is irreversible.';
$_lang['gallery.item_delete_confirm'] = 'Naozaj chcete odstrániť túto položku? Táto akcia je nevratná.';

// $_lang['gallery.item_delete_multiple'] = 'Delete Selected Items';
$_lang['gallery.item_delete_multiple'] = 'Odstrániť vybrané položky';

// $_lang['gallery.item_delete_multiple_confirm'] = 'Are you sure you want to delete these items entirely? This is irreversible.';
$_lang['gallery.item_delete_multiple_confirm'] = 'Naozaj chcete odstrániť vybrané položky? Táto akcia je nenávratná.';

// $_lang['gallery.item_err_nf'] = 'Item not found.';
$_lang['gallery.item_err_nf'] = 'Položka nenájdená.';

// $_lang['gallery.item_err_ns'] = 'Item not specified.';
$_lang['gallery.item_err_ns'] = 'Nebola vybraná položka.';

// $_lang['gallery.item_err_ns_file'] = 'Please specify a file to upload.';
$_lang['gallery.item_err_ns_file'] = 'Vyberte súbor, ktorý chcete nahrať.';
...
$_lang['gallery.prominent_desc'] = 'Nezaškrtnutím tohto políčka učiníte album skrytým.';

// $_lang['gallery.refresh'] = 'Refresh';
$_lang['gallery.refresh'] = 'Obnoviť';

// $_lang['gallery.tags'] = 'Tags';
$_lang['gallery.tags'] = 'Tagy';

// $_lang['gallery.title'] = 'Title';
$_lang['gallery.title'] = 'Titulok';

// $_lang['gallery.width'] = 'Width';
$_lang['gallery.width'] = 'Šírka';

// $_lang['gallery.xpdozip_err_nf'] = 'Could not load xPDOZip class.';
$_lang['gallery.xpdozip_err_nf'] = 'Nemožno načítať triedu xPDOZip.';

// $_lang['gallery.zip_err_ns'] = 'Please specify a zip file.';
$_lang['gallery.zip_err_ns'] = 'Vyberte ZIP súbor.';
...
$_lang['gallery.zip_err_unpack'] = 'Nemožno rozbaliť ZIP súbor. Skontrolujte či nieje ZIP súbor porušený a že ste zadali správnu cestu do galérie.';

// $_lang['gallery.zip_file'] = 'Zip File';
$_lang['gallery.zip_file'] = 'ZIP súbor';

// $_lang['gallery.zip_upload'] = 'Zip Upload';
$_lang['gallery.zip_upload'] = 'Nahratie ZIP súboru';
...
$_lang['gallery.zip_upload_intro'] = '<p>Vyberte ZIP súbor s obrázkami, ktorý chcete nahráť na server, následne dôjde k rozbaleniu daného súboru a obrázky budú umiestené do tohto albumu.</p>';

// $_lang['area_backend'] = 'Backend';
$_lang['area_backend'] = 'Backend';

// $_lang['setting_gallery.backend_thumb_far'] = 'Backend Thumbnail Aspect Ratio';
$_lang['setting_gallery.backend_thumb_far'] = 'Backend pomer strán náhľadu';
...
$_lang['setting_gallery.backend_thumb_far_desc'] = 'Nastavenie pomeru strán pro náhľadu zobrazeného v správcovi obsahu.';

// $_lang['setting_gallery.backend_thumb_height'] = 'Backend Thumbnail Height';
$_lang['setting_gallery.backend_thumb_height'] = 'Backend výška náhľadu';

// $_lang['setting_gallery.backend_thumb_height_desc'] = 'The height in pixels for thumbnails when managing them in the backend.';
$_lang['setting_gallery.backend_thumb_height_desc'] = 'Výška náhľadu pri zobrazení v správcovi obsahu.';

// $_lang['setting_gallery.backend_thumb_width'] = 'Backend Thumbnail Width';
$_lang['setting_gallery.backend_thumb_width'] = 'Backend šírka náhľadu';

// $_lang['setting_gallery.backend_thumb_width_desc'] = 'The width in pixels for thumbnails when managing them in the backend.';
$_lang['setting_gallery.backend_thumb_width_desc'] = 'Šírka náhľadu pri zobrazení v správcovi obsahu.';

// $_lang['setting_gallery.backend_thumb_zoomcrop'] = 'Backend Thumbnail Zoomcrop';
$_lang['setting_gallery.backend_thumb_zoomcrop'] = 'Backend orez náhľadu';
...
$_lang['setting_gallery.backend_thumb_zoomcrop_desc'] = 'Či má byť použitý orez pri zobrazení v správcovi obsahu.';

// $_lang['setting_gallery.default_batch_upload_path'] = 'Default Batch Upload Path';
$_lang['setting_gallery.default_batch_upload_path'] = 'Východzia cesta pre dávkové nahrávanie';

// $_lang['setting_gallery.default_batch_upload_path_desc'] = 'The default value to use for the path when using batch upload.';
$_lang['setting_gallery.default_batch_upload_path_desc'] = 'Východzia cesta, ktorú správca obsahu ponúkne pri použití dávkového nahrávania.';

// $_lang['setting_gallery.thumbs_prepend_site_url'] = 'Prepend Site URL to Thumbs';
$_lang['setting_gallery.thumbs_prepend_site_url'] = 'Pridávať URL portálu k náhľadu';
...
$_lang['setting_gallery.thumbs_prepend_site_url_desc'] = 'Ak je aktívne, systém pridá URL portálu pred každý náhľad poslaný do phpThumb.';