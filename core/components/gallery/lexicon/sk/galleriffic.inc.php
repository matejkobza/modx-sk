...
$_lang['gallery.download_original'] = 'Stiahnuť originál';

// $_lang['gallery.photo_next'] = 'Next Photo';
$_lang['gallery.photo_next'] = 'Následujúca fotka';

// $_lang['gallery.photo_previous'] = 'Previous Photo';
$_lang['gallery.photo_previous'] = 'Predchádzajúca fotka';

// $_lang['gallery.next'] = 'Next';
$_lang['gallery.next'] = 'Ďaľší';

// $_lang['gallery.prev'] = 'Prev';
$_lang['gallery.prev'] = 'Predchádzajúci';

// $_lang['gallery.slideshow_pause'] = 'Pause Slideshow';
$_lang['gallery.slideshow_pause'] = 'Pozastaviť prezentáciu';

// $_lang['gallery.slideshow_play'] = 'Play Slideshow';
$_lang['gallery.slideshow_play'] = 'Spustiť prezentáciu';
