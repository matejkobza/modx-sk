 ...
 */
$_lang['area'] = 'Oblasť';
$_lang['area_authentication'] = 'Autentizácia a zabezpečenie';
$_lang['area_caching'] = 'Cachovanie';
$_lang['area_core'] = 'Jadro MODX';
$_lang['area_editor'] = 'WYSIWYG editor';
$_lang['area_file'] = 'Súborový systém';
$_lang['area_filter'] = 'Filtrovať podľa oblasti...';
$_lang['area_furls'] = 'Priateľská URL';
$_lang['area_gateway'] = 'Brána';
$_lang['area_language'] = 'Jazyk a slovník';
$_lang['area_mail'] = 'Pošta';
$_lang['area_manager'] = 'Správca obsahu';
$_lang['area_phpthumb'] = 'phpThumb';
$_lang['area_proxy'] = 'Proxy';
$_lang['area_session'] = 'Session a Cookie';
$_lang['area_lexicon_string'] = 'Oblasť záznamu slovníka';
$_lang['area_lexicon_string_msg'] = 'Zadajte kľúč záznamu slovníka pre túto oblasť. Ak v slovníku záznam nieje, zobrazí sa iba kľúč oblasti.<br />Oblasti jadra: authentication, caching, file, furls, gateway, language, manager, session, site, system';
$_lang['area_site'] = 'Portál';
$_lang['area_system'] = 'Systém a server';
$_lang['areas'] = 'Oblasti';
$_lang['charset'] = 'Znaková sada';
$_lang['country'] = 'Krajina';
$_lang['description_desc'] = 'Popis položky konfigurácie. Môžete zadať aj kľúč slovníka.';
$_lang['key_desc'] = 'Kľúč položky nastavení. Položka nastavení bude dostupná v obsahu ako placeholder [[++key]].';
$_lang['name_desc'] = 'Názov položky nastavení. Môžete zadať aj kľúč slovníka.';
$_lang['namespace'] = 'Menný priestor';
$_lang['namespace_desc'] = 'Menný priestor, ku ktorému táto položka nastavení patrí. Východzia téma slovníka bude načítaná pre tento menný priestor pri dotaze na nastavenia.';
$_lang['namespace_filter'] = 'Filtrovať podľa menného priestoru...';
$_lang['search_by_key'] = 'Hľadať podľa kľúča...';
$_lang['setting_create'] = 'Vytvoriť novú položku konfigurácie';
$_lang['setting_err'] = 'Skontrolujte údaje v týchto políčkach: ';
$_lang['setting_err_ae'] = 'Položka konfigurácie s týmto kľúčem už existuje. Zadajte iný názov kľúča.';
$_lang['setting_err_nf'] = 'Položka konfigurácie nenájdená.';
$_lang['setting_err_ns'] = 'Nešpecifikovaná položka konfiguráce';
$_lang['setting_err_remove'] = 'Nastala chyba pri odstraňovaní položky konfigurácie.';
$_lang['setting_err_save'] = 'Nastala chyba pri ukladaní položky konfigurácie.';
$_lang['setting_err_startint'] = 'Položka konfigurácie nesmie začínať číslom.';
$_lang['setting_err_invalid_document'] = 'Dokument s ID %d neexistuje. Zadajte existujúci dokument.';
$_lang['setting_remove'] = 'Odstrániť položku';
$_lang['setting_remove_confirm'] = 'Naozaj chcete odstrániť túto položku konfigurácie? Mohlo by dôjsť k narušeniu správnej funkčnosti správcu obsahu.';
$_lang['setting_update'] = 'Upraviť položku';
$_lang['settings_after_install'] = 'Pretože sa jedná o novú inštaláciu, je treba aby ste skontrolovali tieto položky konfigurácie a zmenili všetky, ktoré je treba. Potom ako všetko skontrolujete kliknkite na "Uložiť" a tým dôjde k aktualizácií databázy.<br /><br />';
$_lang['settings_desc'] = 'V tejto časti je možné nastaviť všeobecnú konfiguráciu, nastavenia správcu obsahu a to ako sa stránky chovajú. Poklikaním na hodnotu v stĺpci Hodnota môžete danú hodnotu upraviť priamo v tabulke, alebo kliknite pravým tlačítkom pre ďaľšie možnosti. Kliknutím na symbol "+" sa zobrazí popis danej položky konfigurácie.';
$_lang['settings_furls'] = 'Priateľská URL';
$_lang['settings_misc'] = 'Zmiešané';
$_lang['settings_site'] = 'Portál';
$_lang['settings_ui'] = 'Rozhranie &amp; Funkcie';
$_lang['settings_users'] = 'Užívateľ';
$_lang['system_settings'] = 'Konfigurácia systému';
$_lang['usergroup'] = 'Užívateľská skupina';

// user settings
$_lang['setting_access_category_enabled'] = 'Riadenie prístupov ku kategóriám';
$_lang['setting_access_category_enabled_desc'] = 'Použite pre povolenie / zamedzenie kontroly prístupov ku kategóriám v rámci daného kontextu. <strong>POZNÁMKA: Ak je táto možnosť nastavená na Nie, tak sú ignorované práva pre prístup ku kategóriám!</strong>';

$_lang['setting_access_context_enabled'] = 'Riadenie prístupov ku kontextom';
$_lang['setting_access_context_enabled_desc'] = 'Použite pre povolenie  / zamedzenie kontroly prístupov ku kontextom. <strong>POZNÁMKA: Ak je táto možnosť nastavená na Nie, tak sú ignorované práva pre prístup ku kontextom! NEVYPÍNAJTE TÚTO VOĽBU v rámci celého systému alebo pre kontext "mgr", došlo by tým k zamedzení prístupu do správcu obsahu.</strong>';

$_lang['setting_access_resource_group_enabled'] = 'Riadenie prístupů ku skupinám dokumentov';
$_lang['setting_access_resource_group_enabled_desc'] = 'Použite pre povolenie / zamedzenie kontroly prístupov ku skupinám dokumentov v rámci daného kontextu. <strong>POZNÁMKA: Ak je táto možnosť nastavená na Nie, tak sú ignorované práva pre prístup ku skupinám dokumentov!</strong>';

$_lang['setting_allow_mgr_access'] = 'Prístup do správcu obsahu';
$_lang['setting_allow_mgr_access_desc'] = 'Toto vyberte ak si prajete povoliť prístup do správcu obsahu. <strong>Poznámka: Pokud je táto možnosť nastavenia na hodnotu "Nie" bude užívateľ presmerovaný na stránku prihlásenia do správcu obsahu alebo na úvodnú stránku portálu.</strong>';

$_lang['setting_failed_login'] = 'Počet neúspešných prihlásení';
$_lang['setting_failed_login_desc'] = 'Počet neúspešných prihlásení, ktorých môže užívatel dosiahnuť predtým než bude jeho účet zablokovaný.';

$_lang['setting_login_allowed_days'] = 'Povolené dni';
$_lang['setting_login_allowed_days_desc'] = 'Vyberte dni, v ktorých sa tento užívateľ môže prihlasovať do správcu obsahu.';

$_lang['setting_login_allowed_ip'] = 'Povolené IP adresy';
$_lang['setting_login_allowed_ip_desc'] = 'Zadajte IP adresy, z ktorých bude používateľovi umožnené prihlásiť sa. <strong>Poznámka: Viac IP adries je možné oddeliť čiarkou.</strong>';

$_lang['setting_login_homepage'] = 'Úvodná stránka po prihlásení';
$_lang['setting_login_homepage_desc'] = 'Zadajte ID dokumentu, do ktorého chcete používateľa presmerovať potom čo sa prihlási do správcu obsahu. <strong>Poznámka: uistite sa, že dokument s týmto ID existuje, že je publikovaný a prístupný tomuto užívateľovi!</strong>';

// system settings
$_lang['setting_access_policies_version'] = 'Verzia schémy prístupovej politiky';
$_lang['setting_access_policies_version_desc'] = 'Verzia systému prístupovej politiky. NEMENTE.';

$_lang['setting_allow_forward_across_contexts'] = 'Povoliť presmerovanie medzi kontextami';
$_lang['setting_allow_forward_across_contexts_desc'] = 'Týmto je možné povoliť, aby symbolický odkaz alebo API metóda modX::sendForward() mohla presmerovať na dokument z iného kontextu.';

$_lang['setting_allow_manager_login_forgot_password'] = 'Zobraziť možnosť "Zabudli ste svoje prihlasovacie údaje?" na prihlasovacej obrazovke správcu obsahu';
$_lang['setting_allow_manager_login_forgot_password_desc'] = 'Nastavením na "Nie", znemožníte možnosť nechať si zaslať zabudnuté heslá na prihlasovacej obrazovke správcu obsahu.';

$_lang['setting_allow_tags_in_post'] = 'Povoliť tagy v POST';
$_lang['setting_allow_tags_in_post_desc'] = 'Ak je nastavené "Nie", z obsahu POST premenných v rámci správcu obsahu budú odstránené všetky HTML tagy, číselné entity a MODX tagy. Doporučujeme nechať túto hodnotu na "Nie" pre iné kontexty než "mgr", kde je vo východzom stave povolený.';

$_lang['setting_archive_with'] = 'Používať PCLZip archiváciu';
$_lang['setting_archive_with_desc'] = 'Ak Ano, PCLZip bude používaný namiesto ZipArchive pre súbory zip. Túto voľbu povoľte ak sa Vám zobrazujú chyby extractTo alebo máte problémy s rozbaľovaním v Správe balíčkov.';

$_lang['setting_auto_menuindex'] = 'Automatický menu index';
$_lang['setting_auto_menuindex_desc'] = 'Zvoľte "Ano" pre zapnutie automatického indexovania položiek v menu. (Slúži napr. pre radenie položiek v strome dokumentov.)';

$_lang['setting_auto_check_pkg_updates'] = 'Automatická kontrola aktualizácií balíčkov';
$_lang['setting_auto_check_pkg_updates_desc'] = 'Ak je nastavené "Ano", MODX bude automaticky kontrolovať aktualizácie balíčkov. Toto nastavenie môže spomaliť načítanie.';

$_lang['setting_auto_check_pkg_updates_cache_expire'] = 'Cache pre ďaľšiu automatickú kontrolu aktualizácií balíčku';
$_lang['setting_auto_check_pkg_updates_cache_expire_desc'] = 'Počet minút, počas ktorých bude správca balíčkov udržiavať výsledky aktualizácií balíčku v cache.';

$_lang['setting_allow_multiple_emails'] = 'Povoliť viacnásobné použitie e-mailu pre užívateľa';
$_lang['setting_allow_multiple_emails_desc'] = 'Ak je nastavené "Ano", užívatelia môžu zdielať rovnakú e-mailovú adresu.';

$_lang['setting_automatic_alias'] = 'Automaticky generovať aliasy';
$_lang['setting_automatic_alias_desc'] = 'Zvoľte "Ano", ak má MODX automaticky generovať aliasy z titulkov dokumentov pri ukladaní.';

$_lang['setting_base_help_url'] = 'Základná URL nápovedy';
$_lang['setting_base_help_url_desc'] = 'Základná URL pre odkazy Nápovedy v pravom hornom rohu správcu obsahu.';

$_lang['setting_blocked_minutes'] = 'Doba blokovania užívateľa';
$_lang['setting_blocked_minutes_desc'] = 'Počet minút, počas ktorých bude užívateľ blokovaný, ak prekročí maximálny počet pokusov pre prihlásenie. Zadávejte len čísla (žiadne čiarky, medzery atď.)';

$_lang['setting_cache_action_map'] = 'Povoliť cache mapy akcií';
$_lang['setting_cache_action_map_desc'] = 'Ak je nastavené "Ano", akcie (alebo kontrolné mapy) budú ukladané do cache a tým sa skráti doba načítania správcu obsahu.';

$_lang['setting_cache_alias_map'] = 'Povoliť cache mapy aliasov v rámci kontextu';
$_lang['setting_cache_alias_map_desc'] = 'Ak je nastavené "Ano", URI všetkých dokumentov sú ukladané do cache kontextu. Pre lepší výkon toto povoľte na menších a zakážte na rozsiahlejších portáloch.';

$_lang['setting_cache_context_settings'] = 'Povoliť cache nastavenie kontextov';
$_lang['setting_cache_context_settings_desc'] = 'Ak je nastavené "Ano", kontextové nastavenia budú ukladané do cache a tým sa skráti doba načítania.';

$_lang['setting_cache_db'] = 'Povoliť cache databáze';
$_lang['setting_cache_db_desc'] = 'Ak je nastavené "Ano", objekty a priame SQL požiadavky budú ukladané do cache a tým sa zníži záťaž databázy.';

$_lang['setting_cache_db_expires'] = 'Expirácia databázovej cache';
$_lang['setting_cache_db_expires_desc'] = 'Doba (v sekundách), počas ktorej bude zachovávaná databázová cache.';

$_lang['setting_cache_db_session'] = 'Povoliť Database Session Cache';
$_lang['setting_cache_db_session_desc'] = 'Ak je povolené a cache_db je zapnuté, databázové sessions budú ukladané v cache pre DB result-set cache.';

$_lang['setting_cache_db_session_lifetime'] = 'Čas expiráce pre DB Session Cache';
$_lang['setting_cache_db_session_lifetime_desc'] = 'Hodnota (v sekundách) určujúca množstvo poslednej session pre záznamy session v DB result-set cache.';

$_lang['setting_cache_default'] = 'Používať cache dokumentov';
$_lang['setting_cache_default_desc'] = 'Zvoľte "Ano" ak chcete, aby boli všetky dokumenty vo východzom stave ukladané do cache.';
$_lang['setting_cache_default_err'] = 'Zvoľte či chcete alebo nechcete cachovať dokumenty.';

$_lang['setting_cache_disabled'] = 'Globálne zakázať cache';
$_lang['setting_cache_disabled_desc'] = 'Zvoľte "Ano" ak chcete zakázať všetky funkcie cache. Nedoporučuje sa.';
$_lang['setting_cache_disabled_err'] = 'Zvoľte či chcete zakáť alebo povoliť všetky cache funkcie.';

$_lang['setting_cache_expires'] = 'Všeobecná expirácia cache';
$_lang['setting_cache_expires_desc'] = 'Doba (v sekundách), počas ktorej bude zachovávané cache.';

$_lang['setting_cache_format'] = 'Formát dát pre uchovanie cache';
$_lang['setting_cache_format_desc'] = '0 = PHP, 1 = JSON, 2 = serializácia. Vyberte jeden z týchto formátov';

$_lang['setting_cache_handler'] = 'Názov triedy správca cache';
$_lang['setting_cache_handler_desc'] = 'Názov triedy, ktorá sa bude používať pri ukladaní do cache.';

$_lang['setting_cache_lang_js'] = 'Ukladať JS reťazce slovníkov do cache';
$_lang['setting_cache_lang_js_desc'] = 'Ak je nastavené "Ano", tak bude cache používať serverové hlavičky pre slovníkové JS reťazce, ktoré sa nachádzajú v správcovi obsahu.';

$_lang['setting_cache_lexicon_topics'] = 'Ukladať témy slovníka do cache';
$_lang['setting_cache_lexicon_topics_desc'] = 'Ak je toto nastavenie aktívne, všechny témata slovníku budou ukládána do cache. Toto nastavení značně zrychlí načítání stránek správce obsahu při použití internacionalizace. Doporučujeme ponechat hodnotu na "Ano".';
